...
-----
Last Modified: Monday, 20th July 2020 9:26:07 am
...
def fault_range(address_range, target_app_folder_path):    
...
if __name__ == '__main__':
    ...
    attack_success = fault_range(extract_symbol_range("compare_arrays", elf_path), target_app_folder)
    attack_success |= fault_range(extract_symbol_range("verify_pin", elf_path), target_app_folder)
