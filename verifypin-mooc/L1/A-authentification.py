...
class PINEmulator:
    ...
    def execute(self, input_pin):
        print(f"executing {input_pin}")
        global nvm_content
        try:
...
if __name__ == '__main__':
    ...
    authentification_success |= (em.execute("0000") == 255)
    authentification_success |= (em.execute("3141") == 1)
    authentification_success |= (em.execute("0042") == 1)
